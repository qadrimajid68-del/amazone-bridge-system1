...
export async function POST(req) {
    try {
        ...
        let description = '';
        let rating = '4.6';
        let reviews = '500+ ratings';

        // 3. ⚡ Cloud Anti-Bot Parser
        try {
            ...
            if (jinaData?.data) {
                ...
                if (revMatch) reviews = `${revMatch[1]} ratings`;
            }
        } catch (e) {
            console.log("Cloud parser skipped");
        }
        ...
        return NextResponse.json({
            title: title || `Amazon Official Deal (${cleanAsin})`,
            imageUrl: imageUrl,
            price: price || '19.99',
            description: description || 'Universal verified deal from Amazon marketplace.',
            rating: rating,
            reviews: reviews,
